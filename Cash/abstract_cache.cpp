...
template <typename ID, typename Obj, typename Ptr = Obj*>
class cache
{
public:
...
protected:
	virtual Ptr create_object(ID id) = 0;
...
class test_data_cache : public cache<int, TestData>
{
protected:
	Obj * create_object(ID id)
	{
